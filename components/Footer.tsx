        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-stone-400">
              <li><Link href="/search?city=bangalore" className="hover:text-amber-400 transition">Bangalore Banquet Halls</Link></li>
              <li><Link href="/search?city=mumbai" className="hover:text-amber-400 transition">Mumbai Oceanfront Venues</Link></li>
              <li><Link href="/search?city=delhi-ncr" className="hover:text-amber-400 transition">Delhi NCR Wedding Farms</Link></li>
              <li><Link href="/search?city=hyderabad" className="hover:text-amber-400 transition">Hyderabad Royal Palaces</Link></li>
              <li><Link href="/search?city=chennai" className="hover:text-amber-400 transition">Chennai Coastal Lawns</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-stone-400">
              <li><Link href="/search?occasion=wedding" className="hover:text-amber-400 transition">Grand Weddings & Pheras</Link></li>
              <li><Link href="/search?occasion=reception" className="hover:text-amber-400 transition">Dinner Receptions</Link></li>
              <li><Link href="/search?occasion=engagement" className="hover:text-amber-400 transition">Ring Ceremonies</Link></li>
              <li><Link href="/search?occasion=corporate-event" className="hover:text-amber-400 transition">Corporate Galas & Summits</Link></li>
              <li><Link href="/search?occasion=birthday-party" className="hover:text-amber-400 transition">Milestone Birthday Parties</Link></li>
            </ul>
          </div>
